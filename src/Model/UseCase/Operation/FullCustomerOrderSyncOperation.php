...
class FullCustomerOrderSyncOperation implements JobHandlerInterface, GeneratingHandlerInterface
{
    ...
    public const SYNC_CUSTOMER_OFFSET_CONFIG_KEY = 'KlaviyoIntegrationPlugin.cron.fullCustomerOrderSyncOffset';
    public const IS_ENABLED_WITHOUT_ORDERS_SYNC = 'KlaviyoIntegrationPlugin.config.withoutOrdersSync';
