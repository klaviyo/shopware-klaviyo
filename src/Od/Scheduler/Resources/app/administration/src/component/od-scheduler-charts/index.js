...
Component.register('od-scheduler-charts', {
    ...
    computed: {
        ...
        statisticDateRangesOptions() {
            return [
                {label: this.$tc('sw-dashboard.monthStats.dateRanges.30Days'), value: '30Days'},  
                {label: this.$tc('sw-dashboard.monthStats.dateRanges.14Days'), value: '14Days'},  
                {label: this.$tc('sw-dashboard.monthStats.dateRanges.7Days'), value: '7Days'},  
                {label: this.$tc('sw-dashboard.monthStats.dateRanges.24Hours'), value: '24Hours'},  
                {label: this.$tc('sw-dashboard.monthStats.dateRanges.yesterday'), value: 'yesterday'},  
            ];
        }
    },
