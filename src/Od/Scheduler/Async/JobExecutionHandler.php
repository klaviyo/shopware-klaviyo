...
use Klaviyo\Integration\Od\Scheduler\Model\Job\JobRunner;
...
class JobExecutionHandler implements \Symfony\Component\Messenger\Handler\MessageSubscriberInterface
{
     ...
     */
    public function handle(\Klaviyo\Integration\Od\Scheduler\Async\JobMessageInterface $message): void
    {
        try {
